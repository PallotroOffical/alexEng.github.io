$(document).ready(function(){
    var height = document.getElementById("fullscreen-banner").offsetHeight - document.getElementById("transmenu").offsetHeight;
    var stoptransparency = height+10; // when to stop the transparent menu
